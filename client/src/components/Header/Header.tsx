...
//   const { isActiveTheme, toggleTheme, isHydratedTheme } = useButtonStoreTheme();

//   if (!isHydrated || !isHydratedTheme) {
//     return null;
//   }
...
//   return (
//     <div className={`flex justify-center flex-col w-full items-center ${isActiveTheme ? 'dark' : 'light'}`}>
//       <header className="w-full bg-red-400 opacity-80 flex justify-around items-center py-2">
//         <div className="logo h-20 w-20 flex">
//          <Link href='/'>
//           <img src="/assets/logo_christmas_ornament_store.png" alt="Store Logo" className="hover:cursor-pointer" />
//          </Link>
//         </div>
